...
*
**********************************************************************************************/
/* Modified from original for thesis evaluation (Eötvös Loránd University, 2026).
 * Change: Added TRUST_BOUNDARY annotations to selected public API functions.
 * This is an altered version and must not be misrepresented as the original software.
 * Original source: https://github.com/raysan5/raylib (tag: 5.0)
 * Checker repository: https://github.com/ChandlerCamarena/clang-padding-leakage-checker
 */
...
TRUST_BOUNDARY RLAPI RayCollision GetRayCollisionSphere(Ray ray, Vector3 center, float radius);            // Get collision info between ray and sphere
TRUST_BOUNDARY RLAPI RayCollision GetRayCollisionBox(Ray ray, BoundingBox box);                            // Get collision info between ray and box
TRUST_BOUNDARY RLAPI RayCollision GetRayCollisionMesh(Ray ray, Mesh mesh, Matrix transform);               // Get collision info between ray and mesh
TRUST_BOUNDARY RLAPI RayCollision GetRayCollisionTriangle(Ray ray, Vector3 p1, Vector3 p2, Vector3 p3);    // Get collision info between ray and triangle
TRUST_BOUNDARY RLAPI RayCollision GetRayCollisionQuad(Ray ray, Vector3 p1, Vector3 p2, Vector3 p3, Vector3 p4); // Get collision info between ray and quad
