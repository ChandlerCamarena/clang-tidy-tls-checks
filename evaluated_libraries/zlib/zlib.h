 ...
 * Original source: https://github.com/madler/zlib (tag: v1.3.1)
...
TRUST_BOUNDARY ZEXTERN int ZEXPORT deflate(z_streamp strm, int flush);
/*
...
TRUST_BOUNDARY ZEXTERN int ZEXPORT deflateEnd(z_streamp strm);
/*
...
TRUST_BOUNDARY ZEXTERN int ZEXPORT inflate(z_streamp strm, int flush);
/*
...
TRUST_BOUNDARY ZEXTERN int ZEXPORT inflateEnd(z_streamp strm);
/*
     All dynamically allocated data structures for this stream are freed.
   This function discards any unprocessed input and does not flush any pending
   output.
...
TRUST_BOUNDARY ZEXTERN int ZEXPORT deflateSetHeader(z_streamp strm,
                                     gz_headerp head);
/*
